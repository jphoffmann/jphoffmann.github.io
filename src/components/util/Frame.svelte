...
export let color: keyof BackgroundColor | keyof TextColor | keyof BorderColor = 'default';
...
type BackgroundColor = typeof bgColors;
...
type TextColor = typeof textColors;
...
<svelte:element this={tag} bind:this={node} {...$$restProps} class={divClass} on:click
                on:mouseenter on:mouseleave on:focusin on:focusout {role}>
    <slot/>
</svelte:element>
